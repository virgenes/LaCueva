...
const translations: Record<Language, Record<string, string>> = {
  es: {
    'nav.home': 'Inicio',
    'nav.games': 'Juegos',
    'nav.minigames': 'Mini Juegos',
    'nav.music': 'Música',
    'nav.art': 'Arte',
    'nav.explore': 'Explorar',
    'nav.settings': 'Config',
    'nav.back': 'Volver al Inicio',
    'section.forYou': 'PARA TI',
    'section.faq': '¡Pregúntanos!',
    'section.gallery': 'Galería',
    'section.guestbook': 'Libro de Visitas',
    'section.updates': 'ACTUALIZACIONES DEL SITIO',
    'section.newsfeed': 'NOTICIAS',
    'section.about': 'Si eres nuevo aquí...',
    'section.announcement': 'ANUNCIO',
    'section.games': 'VIDEOJUEGOS',
    'section.music': 'MÚSICA',
    'section.art': 'GALERÍA DE ARTE',
    'settings.title': '⚔️ CONFIGURACIÓN ⚔️',
    'settings.language': 'IDIOMA',
    'settings.theme': 'TEMA DE COLORES',
    'settings.bgMusic': 'MÚSICA DE FONDO',
    'settings.volume': 'Volumen',
    'settings.musicOff': 'Música desactivada por defecto',
    'settings.level': 'Nivel de personalización: MAX',
    'settings.exit': '◄ ESC para salir',
    'settings.cursor': 'CURSOR PERSONALIZADO',
    'settings.cursorHint': 'Desactiva para usar el cursor normal del sistema',
    ...
    'games.description': 'DESCRIPCIÓN',
    'games.downloads': 'DESCARGAS',
    'games.page': 'Página',
    'games.of': 'de',
    'games.found': 'juegos encontrados',
    'exit.title': '¿Seguro que quieres irte?',
    'exit.subtitle': '¡Te extrañaremos!',
    'exit.yes': 'Sí, ¡adiós!',
    'exit.no': '¡NO, me quedo!',
    'footer.visitors': 'visitantes únicos',
    'footer.madeWith': 'Hecho con',
    'footer.by': 'por',
    'footer.followUs': 'SÍGUENOS EN REDES',
    'footer.yourWeb': '¿TU PROPIA WEB?',
    'footer.epicCollection': 'COLECCIÓN ÉPICA',
    'footer.affiliatedBadges': 'insignias afiliadas',
    'footer.rights': 'Todos los derechos reservados',
    'footer.madeWithLove': 'Hecho con 💜 y mucho café ☕',
    ...
    'header.achievement': 'Logro Desbloqueado',
    'header.stalker': 'Stalker Profesional',
    'sidebar.online': 'En línea',
    'sidebar.theCave': 'LA CUEVA',
    'sidebar.ofVirgins': '¡De los Vírgenes!',
    'about.hello': '¡Hola!',
    'about.virgin': 'Virgen',
    'about.potential': 'en potencia',
  ...
  en: {
    ...
    'section.updates': 'SITE UPDATES',
    'section.newsfeed': 'NEWS',
    'section.about': 'If you are new here...',
    'section.announcement': 'ANNOUNCEMENT',
    'section.games': 'VIDEO GAMES',
    'section.music': 'MUSIC',
    'section.art': 'ART GALLERY',
    'settings.title': '⚔️ SETTINGS ⚔️',
    'settings.language': 'LANGUAGE',
    'settings.theme': 'COLOR THEME',
    'settings.bgMusic': 'BACKGROUND MUSIC',
    'settings.volume': 'Volume',
    'settings.musicOff': 'Music disabled by default',
    'settings.level': 'Customization level: MAX',
    'settings.exit': '◄ ESC to exit',
    'settings.cursor': 'CUSTOM CURSOR',
    'settings.cursorHint': 'Disable to use the normal system cursor',
    // Performance settings
    ...
    'exit.title': 'Are you sure you want to leave?',
    'exit.subtitle': "We'll miss you!",
    'exit.yes': 'Yes, goodbye!',
    'exit.no': 'NO, I stay!',
    'footer.visitors': 'unique visitors',
    'footer.madeWith': 'Made with',
    'footer.by': 'by',
    'footer.followUs': 'FOLLOW US',
    'footer.yourWeb': 'YOUR OWN WEBSITE?',
    'footer.epicCollection': 'EPIC COLLECTION',
    'footer.affiliatedBadges': 'affiliated badges',
    'footer.rights': 'All rights reserved',
    'footer.madeWithLove': 'Made with 💜 and lots of coffee ☕',
    ...
    'header.achievement': 'Achievement Unlocked',
    'header.stalker': 'Professional Stalker',
    'sidebar.online': 'Online',
    'sidebar.theCave': 'THE CAVE',
    'sidebar.ofVirgins': 'Of the Virgins!',
    'about.hello': 'Hello!',
    'about.virgin': 'Virgin',
    'about.potential': 'in potential',
