// ============================================================
// ?? CAT芍LOGO DE JUEGOS - LA CUEVA DE LOS V赤RGENES ??
// ============================================================
// 
// INSTRUCCIONES PARA AGREGAR JUEGOS:
// 1. Copia el template de abajo y p谷galo al final del array "games"
// 2. Rellena cada campo seg迆n se indica
...
//   description: "Descripci車n adicional (opcional)",
...
// Lista de g谷neros disponibles para filtrar
export const AVAILABLE_GENRES = [
  "DUNGEON", "DEPORTE", "DISPAROS", "ACCI車N", "CARRERAS", 
...
// ============================================================
// ?? LISTA DE JUEGOS - EDITA AQU赤 ABAJO ??
// ============================================================
export const games: Game[] = [
  {
    ...
    downloads: {
      ...
      SWITCH: [
        ...
        { name: "Actualizaci車n", url: "https://1fichier.com/?xebkn1eluhmvt42zluvy" },
  ...
  },
  {
    ...
    description: "Este juego no tiene formato portable, es tipo ISO, tra赤do desde la p芍gina Blizzboygames, contrase?a si tienen alg迆n problema: www.blizzboygames.net",
    cover: "https://i.imgur.com/ZpE9JDd.png",
    genres: ["DISPAROS", "ACCI車N"],
    platforms: ["PC"],
    downloads: {
      PC: [
  ...
  },
  {
    ...
    downloads: {
      ...
      SWITCH: [
        ...
        { name: "Actualizaci車n (v01.42)", url: "https://fileq.net/xsqi4wouwt8l.html" },
  ...
  },
  {
    ...
    downloads: {
      ...
      SWITCH: [
        ...
        { name: "Actualizaci車n", url: "https://1fichier.com/?s65biyfm5dj3wv2c7ssb&af=1951572" },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    downloads: {
      ...
      SWITCH: [
        ...
        { name: "Actualizaci車n", url: "https://1fichier.com/?eny21nkgh789vz5y40sg&af=1951572" },
      ],
    },
  },
  {
    ...
    downloads: {
      ...
      SWITCH: [
        ...
        { name: "Actualizaci車n", url: "https://1fichier.com/?ldwm56681s77r6xq387k&af=1951572" },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    downloads: {
      ...
      SWITCH: [
        ...
        { name: "Actualizaci車n", url: "https://1fichier.com/?qmlaapqa56e05v35sk45&af=1951572" },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    downloads: {
      ...
      SWITCH: [
        ...
        { name: "Actualizaci車n", url: "https://1fichier.com/?10tutqix29enwveprh7j&af=1951572" },
      ],
    },
  },
  {
    ...
    downloads: {
      ...
      PS2: [
        { name: "MediaFire (Versi車n segura)", url: "https://www.mediafire.com/file/nl3b4xw1kx153du" },
      ],
    },
  },
  {
